...
public class ExtractDateTokens extends AbstractDate implements ColumnAction {
    ...
    public List<Parameter> getParameters(Locale locale) {
        ...
        parameters.add(
                new Parameter.ParameterBuilder().setName(YEAR).setType(ParameterType.BOOLEAN).setDefaultValue(TRUE).createParameter(
                        this, locale));
        parameters.add(
                new Parameter.ParameterBuilder().setName(MONTH).setType(ParameterType.BOOLEAN).setDefaultValue(TRUE).createParameter(
                        this, locale));
        parameters.add(new Parameter.ParameterBuilder().setName(DAY).setType(ParameterType.BOOLEAN).setDefaultValue(TRUE).createParameter(
                this, locale));
        parameters.add(
                new Parameter.ParameterBuilder().setName(HOUR_12).setType(ParameterType.BOOLEAN).setDefaultValue(FALSE).createParameter(
                        this, locale));
        parameters.add(
                new Parameter.ParameterBuilder().setName(AM_PM).setType(ParameterType.BOOLEAN).setDefaultValue(FALSE).createParameter(
                        this, locale));
        parameters.add(
                new Parameter.ParameterBuilder().setName(HOUR_24).setType(ParameterType.BOOLEAN).setDefaultValue(TRUE).createParameter(
                        this, locale));
        parameters.add(
                new Parameter.ParameterBuilder().setName(MINUTE).setType(ParameterType.BOOLEAN).setDefaultValue(TRUE).createParameter(
                        this, locale));
        parameters.add(
                new Parameter.ParameterBuilder().setName(SECOND).setType(ParameterType.BOOLEAN).setDefaultValue(FALSE).createParameter(
                        this, locale));
        parameters.add(new Parameter.ParameterBuilder().setName(DAY_OF_WEEK)
                .setType(ParameterType.BOOLEAN)
                .setDefaultValue(FALSE)
                .createParameter(this, locale));
        parameters.add(new Parameter.ParameterBuilder().setName(DAY_OF_YEAR)
                .setType(ParameterType.BOOLEAN)
                .setDefaultValue(FALSE)
                .createParameter(this, locale));
        parameters.add(new Parameter.ParameterBuilder().setName(WEEK_OF_YEAR)
                .setType(ParameterType.BOOLEAN)
                .setDefaultValue(FALSE)
                .createParameter(this, locale));
        return parameters;
