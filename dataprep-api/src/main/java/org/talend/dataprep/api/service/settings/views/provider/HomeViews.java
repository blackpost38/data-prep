    ...
    ViewSettings APP_HEADER_BAR = AppHeaderBarSettings.builder()
            ...
            .search(
                    SearchSettings.builder()
                            ...
                            .onSelect("appheaderbar.search.types.preparation", MENU_PLAYGROUND_PREPARATION.getId())
                            .onSelect("appheaderbar.search.types.folder", MENU_FOLDERS.getId())
                            .onSelect("appheaderbar.search.types.dataset", DATASET_OPEN.getId())
