...
public class NodeBuilderTest {
    ...
    public void should_append_node_with_provided_link() {
        ...
        // when
        final Node node = NodeBuilder.source(Stream.empty()).to((n) -> new TestLink(n[0]), nextNode).build();
    ...
    public void should_append_a_pipeline() {
        ...
        // when
        final Node node = NodeBuilder.source(Stream.empty()).to(pipeline).to(nodeToAppend).build();
    ...
    public void should_append__clone_link_then_zip_to_a_common_node() {
        ...
        assertThat(branch1.getLink(), instanceOf(ZipLink.class));
        assertThat(branch2.getLink(), instanceOf(ZipLink.class));
