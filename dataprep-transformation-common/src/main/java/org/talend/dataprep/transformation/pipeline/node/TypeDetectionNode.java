...
public class TypeDetectionNode extends ColumnFilteredNode {
    ...
    public TypeDetectionNode(Predicate<? super ColumnMetadata> filter, Function<List<ColumnMetadata>, Analyzer<Analyzers.Result>> analyzer) {
        super(filter);
    ...
    public Node copyShallow() {
        return new TypeDetectionNode(filter, analyzer);
    }
